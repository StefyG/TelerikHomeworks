...
namespace BankAccounts
{
    ...
    public class BankSystemMain
    {
        public static void Main()
        {
            ...
            var companyDeposit = new DepositAccount(new Company("Microsoft INC", 12345, "Bil Gates"), 44352423432, 234);
            ...
            var mortgageAcc = new MortgageAccount(new Company("BFS", 12383128, "Ivan Georgiev"), 2500000, 0.1m);
